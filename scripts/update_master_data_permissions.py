...
target = os.path.join("backend", "src", "api", "v1", "erp", "master_data.py")
...
if import_target in content:
    ...
    with open(target, "w", encoding="utf-8", newline="\r\n") as f:
        f.write(content)
    print("Updated master_data.py endpoints successfully")
else:
    print("Failed to find import_target in master_data.py")
