...
import { VegistHeader } from "@/components/storefront/VegistHeader";
import { VegistNavBar } from "@/components/storefront/VegistNavBar";
      ...
      <div className="min-h-screen bg-[#F2F2F2] font-sans flex flex-col">
        ...
        <footer className="bg-white border-t border-[#E5E4E2] py-16 text-gray-600 text-sm">
          <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div>
              <div className="text-3xl font-black tracking-tight text-[#1A1A1A] mb-6">
                VEG<span className="text-blue-600">IST</span>
              </div>
              <p className="mb-6">We are a team of designers and developers that create high quality Magento, Prestashop, Opencart...</p>
              <div className="space-y-3">
                <div className="flex items-start"><MapPin className="w-5 h-5 mr-3 text-blue-600 flex-shrink-0" /> 4710-4890 Breckinridge St, USA</div>
                <div className="flex items-center"><Mail className="w-5 h-5 mr-3 text-blue-600 flex-shrink-0" /> support@vegist.com</div>
                <div className="flex items-center"><Phone className="w-5 h-5 mr-3 text-blue-600 flex-shrink-0" /> 1-1001-234-5678</div>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="hover:text-blue-600 transition-colors">Legal Notice</a></li>
                <li><a href="#" className="hover:text-blue-600 transition-colors">Prices drop</a></li>
                <li><a href="#" className="hover:text-blue-600 transition-colors">New products</a></li>
                <li><a href="#" className="hover:text-blue-600 transition-colors">Best sales</a></li>
            ...
            <div>
              ...
              <div className="flex space-x-4 mb-8">
                <a href="#" className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all"><Facebook className="w-4 h-4" /></a>
                <a href="#" className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all"><Twitter className="w-4 h-4" /></a>
                <a href="#" className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all"><Instagram className="w-4 h-4" /></a>
                <a href="#" className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all"><Youtube className="w-4 h-4" /></a>
              </div>
          ...
          <div className="container mx-auto px-4 mt-12 pt-6 border-t border-[#E5E4E2] flex flex-col md:flex-row justify-between items-center text-gray-500">
            <div>© 2026 Vegist. All Rights Reserved.</div>
