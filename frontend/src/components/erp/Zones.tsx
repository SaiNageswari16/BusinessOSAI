    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Sub-regional groupings under each geographic region.</p>
        </div>
        <Button className="gradient-brand text-white border-0 gap-2" onClick={() => { setEditZone(null); setShowForm(true); }}>
