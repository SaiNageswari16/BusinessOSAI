    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Multi-level hierarchical approvals and escalations. <span className="font-medium text-primary">{total} total</span></p>
        </div>
