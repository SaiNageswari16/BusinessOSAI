...
<hr/>
<p>Best regards,<br/>Sales & Marketing Team<br/>BusinessOS Corporation</p>`,
    preview: "Bold layout for monsoon sales and customer discount offers" 
  },
  { 
    id: "ST-02",
    name: "Corporate Update & Newsletter", 
    subject: "BusinessOS AI Newsletter: Q3 Milestones & Feature Updates 🚀", 
...
<p>Sincerely,<br/>Phani Kumar<br/>Director, Engineering</p>`,
  ...
  { 
    ...
    subject: "Welcome to BusinessOS Recruitment: Let's build together! 💼", 
...
<hr/>
<p>Warm regards,<br/>HR & Talent Acquisition<br/>BusinessOS AI</p>`,
