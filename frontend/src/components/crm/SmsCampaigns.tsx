...
const smsCampaigns = [
  ...
  { id: "SMS-502", name: "OTP — Order Verification", type: "OTP", recipients: 1, delivered: 1, status: "Sent", date: "2026-07-01", message: "Your BusinessOS verification code is 847291. Valid for 5 mins." },
