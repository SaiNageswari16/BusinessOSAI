          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-2xl max-h-[85vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-150">
            ...
            <div className="p-3 border-b bg-slate-50/50 flex flex-col sm:flex-row gap-2 shrink-0">
              ...
              <div className="flex items-center gap-1.5 shrink-0 flex-wrap">
                ...
                <div className="flex items-center gap-1 text-[11px] font-semibold text-slate-500 ml-1">
                  <span>Size:</span>
                  <select
                    value={multiPageSize}
                    onChange={(e) => {
                    ...
                    className="bg-slate-50 border border-slate-200 rounded-lg px-2 py-0.5 text-xs font-bold text-slate-700 outline-none focus:ring-1 focus:ring-purple-500"
                  >
