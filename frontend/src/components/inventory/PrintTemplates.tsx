...
const INITIAL_TEMPLATES: PrintTemplate[] = [
  ...
  },
  {
    ...
    termsText: "All claims subject to local jurisdiction.",
    bankDetails: "",
    themeName: "luxury",
    fields: {
      showLogo: true,
  ...
  },
  {
    ...
    fontFamily: "Inter, sans-serif",
    headerTitle: "TAX INVOICE",
    storeName: "Commercial Enterprise",
    storeAddress: "",
    storePhone: "",
    gstin: "",
    footerText: "Thank you for your business!",
