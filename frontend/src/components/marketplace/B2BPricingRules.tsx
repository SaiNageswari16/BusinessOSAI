      ...
      {filtered.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filtered.map((rule: any) => (
            <div key={rule.id} className="glass-panel bg-card border border-border/50 rounded-xl p-5 shadow-xs space-y-4 hover:border-purple-500/30 transition-all">
              <div className="flex justify-between items-start">
                <div>
              ...
              {/* Price Ladder Table */}
              <div className="bg-slate-50 border border-border/50 rounded-lg overflow-hidden">
                <table className="w-full text-xs text-left">
                  <thead className="bg-slate-100/80 border-b border-border/50 text-slate-600 font-semibold uppercase tracking-wider text-[10px]">
                    <tr>
                  ...
                  <tbody className="divide-y divide-border/30 font-medium text-slate-700">
