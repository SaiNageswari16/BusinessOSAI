        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs text-left">
            <thead className="bg-slate-50 border-b border-border/50 text-slate-600 text-xs uppercase font-semibold tracking-wider">
              <tr>
                <th className="px-6 py-3.5 text-left whitespace-nowrap">Vendor Name</th>
                <th className="px-6 py-3.5 text-left whitespace-nowrap">Vendor ID</th>
                <th className="px-6 py-3.5 text-left whitespace-nowrap">Category</th>
                <th className="px-6 py-3.5 text-left whitespace-nowrap">Location</th>
                <th className="px-6 py-3.5 text-center whitespace-nowrap">Commission</th>
                <th className="px-6 py-3.5 text-center whitespace-nowrap">Rating</th>
                <th className="px-6 py-3.5 text-right whitespace-nowrap">Orders</th>
                <th className="px-6 py-3.5 text-right whitespace-nowrap">Gross Revenue</th>
                <th className="px-6 py-3.5 text-center whitespace-nowrap">KYC / Status</th>
              </tr>
            </thead>
              ...
              {isLoading ? (
                ...
                filtered.map((vendor) => (
                  <tr key={vendor.id} className="hover:bg-muted/30 transition-colors group">
                    ...
                    <td className="px-6 py-3.5 font-mono font-bold text-slate-700">{vendor.id}</td>
                    <td className="px-6 py-3.5">
                    ...
                    <td className="px-6 py-3.5 text-center">
                      <span className={cn("inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold border",
                        vendor.status === "Active" ? "bg-emerald-50 text-emerald-600 border-emerald-200" :
                        vendor.status === "Pending" ? "bg-amber-50 text-amber-600 border-amber-200" :
