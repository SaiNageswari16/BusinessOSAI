...
class InventoryBatch(Base, UUIDPrimaryKeyMixin, TenantScopedMixin, TimestampMixin):
    ...
    uom: Mapped[str | None] = mapped_column(String(50), default="Pcs")
    cost_price: Mapped[float | None] = mapped_column(Numeric(15, 2), default=0.0)
    mrp: Mapped[float | None] = mapped_column(Numeric(15, 2), default=0.0)
    selling_price: Mapped[float | None] = mapped_column(Numeric(15, 2), default=0.0)
    tax_percent: Mapped[float | None] = mapped_column(Numeric(5, 2), default=0.0)
    location: Mapped[str | None] = mapped_column(String(150), nullable=True)
    supplier_invoice_no: Mapped[str | None] = mapped_column(String(100), nullable=True)
    qc_status: Mapped[str | None] = mapped_column(String(50), default="Passed")
...
class InventorySerial(Base, UUIDPrimaryKeyMixin, TenantScopedMixin, TimestampMixin):
    ...
    product_name: Mapped[str] = mapped_column(String(255), nullable=False)
    sku: Mapped[str | None] = mapped_column(String(100), nullable=True, default="")
