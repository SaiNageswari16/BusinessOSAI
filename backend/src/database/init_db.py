...
async def init_database() -> None:
    ...
    migration_statements = [
        ...
        "ALTER TABLE ar_invoices ADD COLUMN IF NOT EXISTS journal_entry_id UUID REFERENCES journal_entries(id) ON DELETE SET NULL;",
        ...
        "ALTER TABLE ar_invoice_lines ADD COLUMN IF NOT EXISTS cost_center_id UUID REFERENCES cost_centers(id) ON DELETE SET NULL;",
        ...
        "ALTER TABLE erp_master_catalog ADD COLUMN IF NOT EXISTS base_name VARCHAR(150);",
        "ALTER TABLE erp_master_catalog ADD COLUMN IF NOT EXISTS product_base_code VARCHAR(100);",
        "ALTER TABLE erp_master_catalog ADD COLUMN IF NOT EXISTS size_l_kg VARCHAR(50);",
        ...
        "ALTER TABLE erp_products ADD COLUMN IF NOT EXISTS image_url TEXT;",
        "ALTER TABLE erp_product_categories ADD COLUMN IF NOT EXISTS image_url TEXT;",
        "ALTER TABLE erp_brands ADD COLUMN IF NOT EXISTS image_url TEXT;",
        "ALTER TABLE pos_products ADD COLUMN IF NOT EXISTS image_url TEXT;",
        "ALTER TABLE erp_product_images ADD COLUMN IF NOT EXISTS image_url TEXT;",
        "ALTER TABLE erp_master_catalog ADD COLUMN IF NOT EXISTS image_url TEXT;",
        ...
        "ALTER TABLE expense_claims ADD COLUMN IF NOT EXISTS payment_mode VARCHAR(50) DEFAULT 'Online UPI';",
        "ALTER TABLE expense_claims ADD COLUMN IF NOT EXISTS receipt_photo TEXT;",
        "ALTER TABLE expense_claim_lines ADD COLUMN IF NOT EXISTS payment_mode VARCHAR(50) DEFAULT 'Online UPI';",
        "ALTER TABLE expense_claim_lines ALTER COLUMN receipt_url TYPE TEXT;",
