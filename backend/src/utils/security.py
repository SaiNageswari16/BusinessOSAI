...
DEFAULT_PERMISSIONS: list[tuple[str, str, str, str]] = [
    ...
    ("view:paid_ads", "View Paid Ads", "crm", "View Meta paid-ad campaigns and performance"),
    ("manage:paid_ads", "Manage Paid Ads", "crm", "Create and manage Meta paid-ad campaigns, ad sets, and ads"),
